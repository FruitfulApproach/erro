"""
Arrow rename dialog for changing arrow names using lowercase letter buttons.
"""
...
class ArrowRenameDialog(QDialog):
    """Dialog for renaming arrows using lowercase letter buttons and prime marks."""
    
    def __init__(self, current_name="a", parent=None):
        super().__init__(parent)
        self.setWindowTitle("Rename Arrow")
        self.setModal(True)
        self.resize(400, 300)
    ...
    def setup_ui(self):
        ...
        # Title label
        title_label = QLabel("Click letters to build the new arrow name:")
        ...
        # Letter buttons grid (a-z) + "0" - lowercase
